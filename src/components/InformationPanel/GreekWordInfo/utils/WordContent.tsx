...
export function WordContent({wordNumber, greekWordState, showMoreOptions, containerRef} : WordContentProps) {
        ...
        if(containerRef?.current !== null && containerRef?.current !== undefined) {
            ...
            if(el !== null && el !== undefined) {
                if(el.clientHeight >= el.scrollHeight) {
                    let continueReadingBtn = document.getElementById("continueReadingBtn");
                    if(continueReadingBtn !== null && continueReadingBtn !== undefined) {
